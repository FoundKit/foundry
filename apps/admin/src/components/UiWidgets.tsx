...
export function Card({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <div className={cn("bg-slate-900 border border-slate-800/80 rounded-xl p-5 shadow-sm", className)}>
      {children}
    </div>
  );
}
...
export function Input({
  ...
  return (
    <input
      className={cn(
        "w-full bg-slate-950 border border-slate-800 rounded-lg px-3.5 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors",
        className
      )}
      {...props}
    />
...
export function Textarea({
  ...
  return (
    <textarea
      className={cn(
        "w-full bg-slate-950 border border-slate-800 rounded-lg px-3.5 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors resize-y",
        className
      )}
      {...props}
    />
...
export function Badge({
  ...
  const styles = {
    ...
    purple: "bg-indigo-950/60 text-indigo-400 border-indigo-800/60",
  };
