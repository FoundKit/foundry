---
title: "01. Core Types & Trait Abstractions (foundry_core)"
description: "Stage 1: In-depth analysis of Context, Error handling, and SubsystemModule trait abstractions."
---

> **Codebase Navigation**：⬅️ Previous: [Learning Guide & Overview](./) · [📋 Overview & Guide](./) · ➡️ Next: [02. Storage Layer & Model Engine (foundry_storage)](./02-storage/)
...
### 📚 Stage Navigation
- ⬅️ **Previous Stage**: [Learning Guide & Overview](./)
- 📋 **Guide Overview**: [Return to Overview](./)
- ➡️ **Next Stage**: [02. Storage Layer & Model Engine (foundry_storage)](./02-storage/)
