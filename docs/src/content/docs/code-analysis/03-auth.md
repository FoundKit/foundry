---
title: "03. Authentication & RBAC (foundry_auth)"
description: "Stage 3: In-depth analysis of Admin models, password hashing, JWT tokens, and RBAC authorization."
---

> **Codebase Navigation**：⬅️ Previous: [02. Storage Layer & Model Engine (foundry_storage)](./02-storage/) · [📋 Overview & Guide](./) · ➡️ Next: [04. Extension System & Hooks (foundry_extension)](./04-extension/)
...
### 📚 Stage Navigation
- ⬅️ **Previous Stage**: [02. Storage Layer & Model Engine (foundry_storage)](./02-storage/)
- 📋 **Guide Overview**: [Return to Overview](./)
- ➡️ **Next Stage**: [04. Extension System & Hooks (foundry_extension)](./04-extension/)
