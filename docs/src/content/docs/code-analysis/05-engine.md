---
title: "05. Request Engine & Auto-CRUD (foundry_engine)"
description: "Stage 5: In-depth analysis of Axum route assembly, middleware stack, Auto-CRUD engine, and audit logging."
---

> **Codebase Navigation**：⬅️ Previous: [04. Extension System & Hooks (foundry_extension)](./04-extension/) · [📋 Overview & Guide](./) · ➡️ Next: [06. Facade Layer & Assembly (foundry)](./06-foundry/)
...
### 📚 Stage Navigation
- ⬅️ **Previous Stage**: [04. Extension System & Hooks (foundry_extension)](./04-extension/)
- 📋 **Guide Overview**: [Return to Overview](./)
- ➡️ **Next Stage**: [06. Facade Layer & Assembly (foundry)](./06-foundry/)
