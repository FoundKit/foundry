---
title: "Codebase Deep Dive & Learning Guide"
description: "Systematic learning path, architecture overview, data flow, and request lifecycle for Foundry."
---


> **📚 Code Analysis Stage Navigation**:
> 1. [Stage 1: Core Types & Interfaces (foundry_core)](./01-core/)
> 2. [Stage 2: Storage Layer & Dynamic Models (foundry_storage)](./02-storage/)
> 3. [Stage 3: Authentication & RBAC System (foundry_auth)](./03-auth/)
> 4. [Stage 4: Extension System & Lifecycle Hooks (foundry_extension)](./04-extension/)
> 5. [Stage 5: Request Engine & Auto-CRUD (foundry_engine)](./05-engine/)
> 6. [Stage 6: Facade Layer & Application Assembly (foundry)](./06-foundry/)
> 7. [Stage 7: Blog Platform Full-Stack Real-World Example](./07-blog-platform/)
> 8. [Stage 8: Admin Frontend Console Deep Dive (apps/admin)](./08-admin-frontend/)
