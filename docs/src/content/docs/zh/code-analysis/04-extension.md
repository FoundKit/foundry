---
title: "04. 扩展系统与生命周期钩子 (foundry_extension)"
description: "阶段 4：深度剖析 HookContext、ExtensionRegistry、HookRunner 以及各类扩展点。"
---

> **源码导读导航**：⬅️ 上一篇：[03. 认证与权限控制系统 (foundry_auth)](./03-auth/) · [📋 学习指南与总览](./) · ➡️ 下一篇：[05. 请求引擎与自动 CRUD (foundry_engine)](./05-engine/)
...
### 📚 阶段导航
- ⬅️ **上一阶段**：[03. 认证与权限控制系统 (foundry_auth)](./03-auth/)
- 📋 **学习指南总览**：[返回源码深度理解总览](./)
- ➡️ **下一阶段**：[05. 请求引擎与自动 CRUD (foundry_engine)](./05-engine/)
