---
title: "06. 门面层与应用组装 (foundry)"
description: "阶段 6：深度剖析 FoundryApp、FoundryBuilder 构建器模式与启动流程。"
---

> **源码导读导航**：⬅️ 上一篇：[05. 请求引擎与自动 CRUD (foundry_engine)](./05-engine/) · [📋 学习指南与总览](./) · ➡️ 下一篇：[07. 博客实战示例应用 (blog_platform)](./07-blog-platform/)
...
### 📚 阶段导航
- ⬅️ **上一阶段**：[05. 请求引擎与自动 CRUD (foundry_engine)](./05-engine/)
- 📋 **学习指南总览**：[返回源码深度理解总览](./)
- ➡️ **下一阶段**：[07. 博客实战示例应用 (blog_platform)](./07-blog-platform/)
