...
if [ -d "${PROJECT_ROOT}/apps/admin" ]; then
    ...
    mkdir -p "${PROJECT_ROOT}/crates/foundry_engine/admin_dist"
    cp -r "${PROJECT_ROOT}/apps/admin/dist/"* "${PROJECT_ROOT}/crates/foundry_engine/admin_dist/"
    echo "✅ Admin SPA compiled into release bundle and engine embedded assets."
fi
